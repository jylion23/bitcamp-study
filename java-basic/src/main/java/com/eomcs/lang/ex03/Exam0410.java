...
public class Exam0410 {
  public static void main(String[] args) {
    ...
    //    폰트 파일에서 찾아 출력
    //    만약 폰트 파일에 해당 코드의 문자가 없으면 출력하지 못함
    ...
    //    직접 문자를 적는 대신 그 문자에 부여된 코드 값을 지정 가능
    //    문자에 대해 부여된 값을 '문자 코드(Character code)' 라 부름
    //    코드 값은 사용하는 문자 집합에 따라 다름
    //    자바는 '유니코드(UTF-16BE; UCS2)' 라는 문자집합을 사용
    //    \ u 뒤에 문자에 부여된 코드 값을 16진수로 적늗나.
    //    u는 소문자로 적어야함
